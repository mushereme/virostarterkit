...
```
cd existing_repo
git remote add origin https://gitlab.com/smart-quality/suburb-mobile.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/smart-quality/suburb-mobile/-/settings/integrations)
